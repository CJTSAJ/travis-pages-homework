import Vue from 'vue'
import CategoryStartups from 'components/categories/categoryStartups/categoryStartups'

describe('categoryStartups.vue', () => {
  it('show', () => {
    const Constructor = Vue.extend(CategoryStartups);
